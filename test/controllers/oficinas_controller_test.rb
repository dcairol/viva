...
class OficinasControllerTest < ActionController::TestCase
  ...
  test "should create oficina" do
    assert_difference('Oficina.count') do
      post :create, oficina: { direccion: @oficina.direccion, nombre: @oficina.nombre, responsable: @oficina.responsable }
    end
  ...
  test "should update oficina" do
    patch :update, id: @oficina, oficina: { direccion: @oficina.direccion, nombre: @oficina.nombre, responsable: @oficina.responsable }
    assert_redirected_to oficina_path(assigns(:oficina))
  end
